...
object Constant {
    ...
    const val INVALID_EMAIL_COMMAN_MSG = "Please enter the valid email id with contains of (Min 6 char, @ and .com)"
    const val INVALID_EMAIL_EMPTY_ERROR = "Email should not be empty"
    const val INVALID_EMAIL_ANDPARSENT_NOT_ERROR= "Email should contain @ symbol"
    ...
    const val INVALID_PASSWORD_COMMAN_ERROR = "Please enter the valid password with contains of (Min 6 char, symbol and number)"
